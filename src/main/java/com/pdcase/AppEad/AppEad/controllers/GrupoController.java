...
import com.pdcase.AppEad.AppEad.repository.GrupoRepository;
import com.pdcase.AppEad.AppEad.repository.ProjetoRepository;
import com.pdcase.AppEad.AppEad.repository.UsuarioRepository;
...
public class GrupoController {
	...
	// DELETAR GRUPO
	    ...
	    public String detalhesGrupoPost(@PathVariable("id") long id, @Valid Usuario usuario, BindingResult result, RedirectAttributes attributes) {
	    	if (result.hasErrors()) {
				System.out.println(result.getAllErrors());
				attributes.addFlashAttribute("mensagem", "Verifique os campos");
				return "redirect:/{id}";
	        ...
	        ur.save(usuario);
	        attributes.addFlashAttribute("mensagem", "Usuario adicionada com sucesso!");
		...
		public String adicionarProjetoAoGrupo(
		    @PathVariable("id") long idGrupo,
		    @RequestParam("projetoId") long idProjeto,
		    ...
		    if (grupo == null || projeto == null) {
		        attributes.addFlashAttribute("mensagem", "Grupo ou projeto não encontrado!");
		    ...
		    attributes.addFlashAttribute("mensagem", "Projeto adicionado com sucesso ao grupo!");
		    return "redirect:/grupo/" + idGrupo ;
		}
		...
		public String removerProjetoDoGrupo(@PathVariable("id") Long idGrupo,
		                                    @RequestParam("projetoId") Long idProjeto) {
		...
		public String adicionarAulaAoGrupo(
		    @PathVariable("id") long idGrupo,
		    @RequestParam("aulaId") long idAula,
		    RedirectAttributes attributes) {
		    ...
		    attributes.addFlashAttribute("mensagem", "Aula adicionado com sucesso ao grupo!");
		    return "redirect:/grupo/" + idGrupo;
		}
		
		//Remover Aula de Grupo
		@PostMapping("/grupo/{id}/remover-aula")
		public String removerAulaDoGrupo(@PathVariable("id") Long idGrupo,
		                                    @RequestParam("aulaId") Long idAula) {
		    Grupo grupo = gr.findById(idGrupo).orElse(null);
